...
class AnimalListRepository {
    ...
    private static let animal2 = Animal(id: 2, name: "Серый волк", shortDescription: "Canis lupus", description: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", placeholderColor: UIColor.lightGray)
    private static let animal3 = Animal(id: 3, name: "Пума", shortDescription: "Puma concolor", description: "But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. ", placeholderColor: UIColor.lightGray)
    private static let animal4 = Animal(id: 4, name: "Койот", shortDescription: "Canis latrans", description: "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.", placeholderColor: UIColor.lightGray)
    private static let animal5 = Animal(id: 5, name: "Рысь", shortDescription: "Lynx", description: "Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus.", placeholderColor: UIColor.lightGray)
    private static let animal6 = Animal(id: 6, name: "Собака", shortDescription: "Canis lupus familiaris", description: "Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.", placeholderColor: UIColor.lightGray)
    private static let animal7 = Animal(id: 7, name: "Пантера", shortDescription: "Panther", description: "On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal blame belongs to those who fail in their duty through weakness of will, which is the same as saying through shrinking from toil and pain.", placeholderColor: UIColor.lightGray)
