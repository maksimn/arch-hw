...
class AnimalListRepository {
    ...
    private static let animal2 = Animal(id: 2, name: "Серый волк", shortDescription: "Canis lupus", description: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.")
